...
QT_MOC_LITERAL(1, 8, 8), // "isActive"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 4), // "name"
QT_MOC_LITERAL(4, 23, 6), // "start2"
QT_MOC_LITERAL(5, 30, 7), // "program"
QT_MOC_LITERAL(6, 38, 9) // "arguments"

    },
    "Process\0isActive\0\0name\0start2\0program\0"
    "arguments"
};
...
void Process::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { bool _r = _t->isActive((*reinterpret_cast< const QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 1: _t->start2((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QVariantList(*)>(_a[2]))); break;
        default: ;
        }
    }
}
